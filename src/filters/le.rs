...
impl<Value, Input> ScalarFilter<Value, Input> for LessEqual<Value>
where
...
impl VectorFilter<__m512i, i32, __mmask16> for LessEqual<i32> {
...
impl VectorFilter<__m512i, i64, __mmask8> for LessEqual<i64> {
